            ...
            teamMembers: [
              {
                ...
                experience: [
                  { role: 'CEO & Fundadora', company: 'DomoticLink', duration: '2018 - Presente' },
                  { role: 'Directora de Tecnología', company: 'SmartHomes', duration: '2015 - 2018' },
                  { role: 'Ingeniera de Software', company: 'TechSolutions', duration: '2012 - 2015' }
                ]
              },
              {
                name: 'Carlos Mendoza',
                ...
                experience: [
                  { role: 'Director de Operaciones', company: 'DomoticLink', duration: '2019 - Presente' },
                  { role: 'Gerente de Proyectos', company: 'HomeTech', duration: '2016 - 2019' },
                  { role: 'Coordinador de Operaciones', company: 'SmartLiving', duration: '2013 - 2016' }
                ]
              },
              {
                name: 'Ana Torres',
              ...
              },
              {
                ...
                experience: [
                  { role: 'Gerente de Ventas', company: 'DomoticLink', duration: '2020 - Presente' },
                  { role: 'Ejecutivo de Ventas', company: 'HomeTech', duration: '2018 - 2020' },
                  { role: 'Asesor Comercial', company: 'SmartLiving', duration: '2016 - 2018' }
                ]
              },
              {
                name: 'Laura Torres',
                ...
                experience: [
                  { role: 'Directora de Marketing', company: 'DomoticLink', duration: '2020 - Presente' },
                  { role: 'Gerente de Marketing Digital', company: 'DigitalHome', duration: '2018 - 2020' },
                  { role: 'Especialista en Redes Sociales', company: 'CreativeMinds', duration: '2016 - 2018' }
                ]
              },
              {
                ...
                experience: [
                  { role: 'Asesor Legal', company: 'DomoticLink', duration: '2019 - Presente' },
                  { role: 'Abogado Senior', company: 'LegalCorp', duration: '2016 - 2019' },
                  { role: 'Asociado Legal', company: 'Derecho & Asociados', duration: '2013 - 2016' }
                ]
              }
            ],
            openModal(member) {
